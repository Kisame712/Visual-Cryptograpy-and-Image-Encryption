...
import hashlib
# My key
K = "0iV22p2SAbVRskJPni8D7okmxhmeQGipvlmfu3sCE6Lqu4espMuxDTmajKdjBDtDjoKJ2cC9k4FT2a2x"
...
# K1="0jV22p2SAbVRskJPni8D7okmxhmeQGipvlmfu3sCE6Lqu4espMuxDTmajKdjBDtDjoKJ2cC9k4FT2a2x"
...
class AESCipher:
    ...
    def decrypt(self):
        ...
        cipher = AES.new(self.key,AES.MODE_OFB,iv)
        return self.unpad(cipher.decrypt(cipher_text[self.block_size:])).decode('utf-8','replace')
